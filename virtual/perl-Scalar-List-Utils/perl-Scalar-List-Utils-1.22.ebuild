...
# The purpose of this virtual is to provide the ability to utilize the
# built-in Scalar-List-Util of the base dev-lang/perl package.
RDEPEND="|| ( =dev-lang/perl-5.12* =dev-lang/perl-5.10* ~perl-core/${PN#perl-}-${PV} )"
